...
const pedidoAcidente = {
  ...
  grupos: [
    {
      titulo: 'Vítima, acidente e prescrição',
      campos: [
        // Nascimento e sexo moram com as demais datas, no topo, para serem
        // preenchidos junto com elas; só a pensão os usa (tábua do IBGE).
        { id: 'dataNascimento', rotulo: 'Data de nascimento', tipo: 'data',
          dica: 'Com ela e o sexo, a sobrevida da pensão sai da tábua do IBGE, pela idade na data da ciência.' },
        { id: 'sexo', rotulo: 'Sexo da vítima', tipo: 'select', valor: '',
